item replace entity @s armor.head with minecraft:player_head[minecraft:custom_name='{"text":""}',profile={id:[I;1758717978,301942505,-1583270002,1505287020],properties:[{name:"textures",value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGVmMmM2ZDI4NWUwNTBmYjcyYTU2ODk5MjU4YTFkMTMzZjJhYzI3ODcwNDNlYWJiNDY5ZDU2ZTkzZTBkZDU1In19fQ=="}]}] 1
item replace entity @s armor.chest with leather_chestplate[dyed_color={rgb:9605778, show_in_tooltip:false}]
